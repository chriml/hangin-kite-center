...
| Current | An accessible internal complaint route is required. Under the Internet Transactions Act, the internal mechanism is treated as exhausted when a complaint remains unresolved after seven calendar days. | [RA 11967](https://lawphil.net/statutes/repacts/ra2023/ra_11967_2023.html), secs. 23(i) and 24; [JAO 24-03](https://ecommerce.dti.gov.ph/wp-content/uploads/2024/06/Joint-Administrative-Order-No.-24-03.pdf), secs. 34(j) and 38; [DTI Consumer Care](https://consumercare.dti.gov.ph/). |
...
## Decisions for current message-based bookings and future online payment

These decisions can already apply to bookings accepted or paid through WhatsApp/email. Confirm the current real-world sales flow first; a future website checkout is not the only trigger.
...
1. **Website use and inquiries.** The implemented public page. It explains website inquiries, service preparation and complaint contacts.
...
## Pinpoint verification, 2026-09-05

The original 21-page JAO 24-03 from the prior official-source research was visually rechecked: price disclosure is §34(b), p. 14; homepage disclosure §34(g)(1), p. 15; redress §34(j), p. 16; and all-sales invoices §34(i), p. 16. The fresh [DTI PDF endpoint](https://ecommerce.dti.gov.ph/wp-content/uploads/2024/06/Joint-Administrative-Order-No.-24-03.pdf) returned 502. The retained original hash is `3915f99244c8f25d5c477cbc7e906599155ed4cde69e9332cb2f700190f95608`. This corrects citations, not the unresolved business classification.
