...
| `public/file.svg`; `public/globe.svg`; `public/next.svg`; `public/vercel.svg`; `public/window.svg` | Starter assets present in the reviewed baseline. No app/component usage found by source search. | Not in the original provenance ledger; generator/version/licence evidence not established here. Remove unused files in the integration change or record provenance before retaining them in the export. |

## Authorized editorial fixes and publication gates

Keep existing documentary alt text factual. Add “Resized and converted to WebP” to visible CC credits, with creator/source/licence links. Proposed generated captions are “Generated illustration, not current shop stock”, “Generated illustration, not a photograph of a Hangin safari”, and “Generated illustration, not a photograph of a Hangin room”. Decorative artwork keeps empty alt text. These controls are authorized preparation; their rendered implementation is verified by the integration task, not by this document.
