...
| Prices and tax | The site has no prices, price comparisons, discounts, or fee disclosures. | Tests reject “message/WhatsApp/email for rates” wording. | A signed-off PHP price matrix with tax status, mandatory fees, inclusions, exclusions, and validity dates. |
...
| Images | Generated illustrations are already labelled in the image registry and are not presented as documentary photos. Third-party location photos have source and licence credits. | Added a test that generated art remains decorative with empty alt text. | Written permission/provenance for any future staff, facility, room, gear, or trip proof image. |
