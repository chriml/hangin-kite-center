...
The [review-remediation report](../operations/review-remediation-2026-09-04.md) supersedes the original nine-route/40-test baseline. It records a successful default Turbopack build, 105 tests, the consolidated privacy audit and bounded browser evidence. Future acceptance below means the entire current route set and test suite.

- The site is a Next.js 16.3.3 static export covering the public routes declared in `content/site.ts` and no client components or runtime third-party scripts.
