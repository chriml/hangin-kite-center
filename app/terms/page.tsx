        ...
        <div className={styles.sections}>
          ...
          <section id="third-parties" aria-labelledby="third-parties-heading">
            <p className={styles.sectionNumber}>03</p><div>
              ...
              <p>Photo credits identify the source and license of third-party images. Their reuse follows those licenses. Generated artwork is supporting illustration. See the <a href="/images/ATTRIBUTION.md">image credits</a>.</p>
            </div>
          </section>
